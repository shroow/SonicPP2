...
protected:
    ...
    std::function<void(CCollider*, CCollider*)> m_CollisionOn;
...
public:
    ...
    const std::list<CSharedPtr<CCollider>>* GetCollisionList()    const
    {
        return &m_CollisionList;
    }

    void SetCollisionChannel(ECollision_Channel Channel)
    {
...
public:
    ...
    void CallCollisionOn(CCollider* Dest);
...
public:
    ...
    virtual Vector2 GetPoint() const = 0;
...
public:
    ...
    template <typename T>
    void SetCollisionOnFunction(T* Obj, void(T::* Func)(CCollider*, CCollider*))
    {
        m_CollisionOn = std::bind(Func, Obj, std::placeholders::_1, std::placeholders::_2);
    }
