...
private:
	...
	HWND	m_hColliderRadius;
	HWND	m_hDeleteRadius;
	HWND	m_hColliderCombo;
	ECollider_Type		m_SelectCollider;
	float	m_ColliderStatus;
...
public:
	...
	bool GetColliderCheck()	const
	{
		return SendMessage(m_hColliderRadius, BM_GETCHECK, 0, 0) == BST_CHECKED;
	}

	bool GetDeleteCheck()	const
	{
		return SendMessage(m_hDeleteRadius, BM_GETCHECK, 0, 0) == BST_CHECKED;
	}
	...
	ECollider_Type GetSelectCollider()	const
	{
		return 	m_SelectCollider;
	}
